<?php
/**
 * Template Name: Section - Research &amp; Development (Landing)
 */
get_header();
vtg_page_hero(array('title'=>'Research &amp; Development','intro'=>'Shaping applied AI through focused research themes, tools, and publications.','breadcrumbs'=>array(array('label'=>'Research &amp; Development'))));
$sitemap = vtg_get_sitemap();
$children = $sitemap['research']['children'] ?? array();
$home = home_url();
$icons = array('&#x1F4A1;','&#x1F52C;','&#x25C9;','&#x1F6E0;','&#x1F4C4;');
?>
